...
This document provides an overview of the Filanwaa project for developers and AI agents working on this codebase.

## Project Overview

Filanwaa is a bilingual (English & Somali) knowledge platform covering IT, Islamic Religion, and Somali Literature. Built with TanStack Start and deployed on Netlify.
